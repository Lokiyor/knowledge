package com.lokiy.mp.generator;
 ...
 * @author Lokiy
 * @date 2019/8/5 16:35
 * @description: mybatis-plus 代码生成器模板
 */
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        strategy.setSuperEntityClass("com.lokiy.mp.common.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        // 公共父类
        strategy.setSuperControllerClass("com.lokiy.mp.common.BaseController");
        // 写于父类中的公共字段
